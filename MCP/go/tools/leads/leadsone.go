...
func LeadsoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetLeadResponse
...
func CreateLeadsoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_lead_leads_id",
		mcp.WithDescription("Get lead"),
