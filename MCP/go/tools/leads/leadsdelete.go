...
func LeadsdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteLeadResponse
...
func CreateLeadsdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_lead_leads_id",
		mcp.WithDescription("Delete lead"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    LeadsdeleteHandler(cfg),
	}
}
