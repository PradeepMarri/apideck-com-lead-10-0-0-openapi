...
func LeadsallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetLeadsResponse
...
func CreateLeadsallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_lead_leads",
		mcp.WithDescription("List leads"),
